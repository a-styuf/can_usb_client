...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.unitsSArea.setGeometry(QtCore.QRect(0, 0, 761, 674))
        ...
        self.addUnitPButton.setMinimumSize(QtCore.QSize(225, 30))
        self.addUnitPButton.setObjectName("addUnitPButton")
        self.gridLayout_2.addWidget(self.addUnitPButton, 0, 0, 1, 2)
        spacerItem = QtWidgets.QSpacerItem(231, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.dataTWidget.setMinimumSize(QtCore.QSize(260, 0))
